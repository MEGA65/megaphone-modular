...
int main(int argc,char **argv)
{
  ...
  printf("// DO NOT EDIT -- Automatically generated by tools/gen_attr_tables.c\n\n");
  ...
  for(int i=0;i<64;i++)
    {
      ...
      // Select alternate palette for colour glyphs.
      // Relies on BOLDISALT bit set in $D053 so that REVERSE
      // isn't required to be set. This allows us to control REVERSE
      // indepdently
      unsigned char val = 0x00;      
      val |= is_colour? 0x40 : 0x00;  
