...
bin/modem:	src/telephony/modem.c src/telephony/linux/hal.c src/telephony/buffers.c
	mkdir -p bin
	gcc -DSTANDALONE -Wall -Isrc/telephony -Isrc/telephony/linux -g -o bin/modem $< src/telephony/linux/hal.c src/telephony/buffers.c
